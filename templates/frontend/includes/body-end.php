                    ...
                    <div class="tf-compare-offcanvas list-empty">
                        ...
                        <div class="tf-compare-item file-delete">
                            <a href="product-detail.html">
                                ...
                                <img class="radius-3 lazyload" data-src="images/products/gym/product-1.jpg"
                                    src="images/products/gym/product-1.jpg" alt="Image">
                            </a>
                        </div>
                        <div class="tf-compare-item file-delete">
                            <a href="product-detail.html">
                                ...
                                <img class="radius-3 lazyload" data-src="images/products/gym/product-3.jpg"
                                    src="images/products/gym/product-3.jpg" alt="Image">
                            </a>
                        </div>
                        <div class="tf-compare-item file-delete">
                            <a href="product-detail.html">
                                ...
                                <img class="radius-3 lazyload" data-src="images/products/gym/product-7.jpg"
                                    src="images/products/gym/product-7.jpg" alt="Image">
                            </a>
                        </div>
                    </div>
                ...
                <div dir="ltr" class="swiper tf-single-slide">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide" data-color="pink">
                            <div class="item">
                                <img class="lazyload" data-src="images/products/gym/product-3.jpg" src="images/products/gym/product-3.jpg"
                                    alt="Image">
                            </div>
                        </div>
                        <div class="swiper-slide" data-color="pink">
                            <div class="item">
                                <img class="lazyload" data-src="images/products/gym/product-4.jpg" src="images/products/gym/product-4.jpg"
                                    alt="Image">
                            </div>
                        </div>
                        <div class="swiper-slide" data-color="blue">
                            <div class="item">
                                <img class="lazyload" data-src="images/products/gym/product-5.jpg" src="images/products/gym/product-5.jpg"
                                    alt="Image">
                            </div>
                        </div>
                        <div class="swiper-slide" data-color="black">
                            <div class="item">
                                <img class="lazyload" data-src="images/products/gym/product-6.jpg" src="images/products/gym/product-6.jpg"
                                    alt="Image">
                            </div>
                        </div>
                    </div>
            ...
            <div class="tf-product-info-wrap">
                <div class="tf-product-info-inner tf-product-info-list">
                    <div class="tf-product-info-heading">
                        <a href="product-detail.html" class="link product-info-name fw-medium h1"> Breathable workout gloves </a>
                ...
                <div class="trend-product-inner">
                    <div class="trend-product-list">
                        <div class="trend-product-item">
                            <div class="image">
                                <img class="lazyload" src="images/products/gym/product-1.jpg" data-src="images/products/gym/product-1.jpg"
                                    alt="Product">
                            </div>
                            <div class="content">
                                <div class="text-small text-main-2 sub">Whey</div>
                                <h6 class="title">
                        ...
                        <div class="trend-product-item">
                            <div class="image">
                                <img class="lazyload" src="images/products/gym/product-3.jpg" data-src="images/products/gym/product-3.jpg"
                                    alt="Product">
                            </div>
                            <div class="content">
                                <div class="text-small text-main-2 sub">Whey</div>
                    ...
                    <div class="trend-product-list">
                        <div class="trend-product-item">
                            <div class="image">
                                <img class="lazyload" src="images/products/gym/product-7.jpg" data-src="images/products/gym/product-7.jpg"
                                    alt="Product">
                            </div>
                            <div class="content">
                                <div class="text-small text-main-2 sub">Whey</div>
                        ...
                        <div class="trend-product-item">
                            <div class="image">
                                <img class="lazyload" src="images/products/gym/product-9.jpg" data-src="images/products/gym/product-9.jpg"
                                    alt="Product">
                            </div>
                            <div class="content">
                                <div class="text-small text-main-2 sub">Whey</div>
        ...
        <div class="wrap-recommendations">
            <div class="list-cart">
                <div class="list-cart-item">
                    <div class="image">
                        <img class="lazyload" data-src="images/products/gym/product-1.jpg" src="images/products/gym/product-1.jpg" alt="Image">
                    </div>
                    <div class="content">
                        <h6 class="name">
                ...
                <div class="list-cart-item">
                    <div class="image">
                        <img class="lazyload" data-src="images/products/gym/product-3.jpg" src="images/products/gym/product-3.jpg" alt="Image">
                    </div>
                    <div class="content">
                        <h6 class="name">
                ...
                <div class="list-cart-item">
                    <div class="image">
                        <img class="lazyload" data-src="images/products/gym/product-7.jpg" src="images/products/gym/product-7.jpg" alt="Image">
                    </div>
                    <div class="content">
                        <h6 class="name">
                ...
                <div class="list-cart-item">
                    <div class="image">
                        <img class="lazyload" data-src="images/products/gym/product-9.jpg" src="images/products/gym/product-9.jpg" alt="Image">
                    </div>
                    <div class="content">
                        <h6 class="name">
                        ...
                        <div class="tf-mini-cart-items list-empty">
                            ...
                            <div class="tf-mini-cart-item file-delete">
                                <div class="tf-mini-cart-image">
                                    <img class="lazyload" data-src="images/products/gym/product-13.jpg" src="images/products/gym/product-13.jpg"
                                        alt="img-product">
                                </div>
                            ...
                            <div class="tf-mini-cart-item file-delete">
                                <div class="tf-mini-cart-image">
                                    <img class="lazyload" data-src="images/products/gym/product-17.jpg" src="images/products/gym/product-17.jpg"
                                        alt="img-product">
                                </div>
                                <div class="tf-mini-cart-info">
                                    <div class="text-small text-main-2 sub">Whey</div>
                            ...
                            <div class="tf-mini-cart-item file-delete">
                                <div class="tf-mini-cart-image">
                                    <img class="lazyload" data-src="images/products/gym/product-19.jpg" src="images/products/gym/product-19.jpg"
                                        alt="img-product">
                                </div>
                                <div class="tf-mini-cart-info">
                                    <div class="text-small text-main-2 sub">Whey</div>
                            ...
                            <div class="tf-mini-cart-item file-delete">
                                <div class="tf-mini-cart-image">
                                    <img class="lazyload" data-src="images/products/gym/product-23.jpg" src="images/products/gym/product-23.jpg"
                                        alt="img-product">
                                </div>
                                <div class="tf-mini-cart-info">
                                    <div class="text-small text-main-2 sub">Whey</div>
