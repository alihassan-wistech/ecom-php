        ...
        <div class="row align-items-center">
            ...
            <div class="col-xl-3 col-md-4 col-6 d-flex justify-content-center justify-content-xl-start">
                <a href="index.html" class="logo-site">
                    <img src="<?php echo asset("assets/new-design/images/logo.png") ?>" alt="Logo">
                </a>
            </div>
                                            ...
                                            <ul class="list-hor">
                                                <li class="wg-cls hover-img">
                                                    <a href="shop-default.html" class="image img-style">
                                                        <img src="images/products/gym/product-1.jpg"
                                                            data-src="images/products/gym/product-1.jpg" alt="Collection" class="lazyload">
                                                    </a>
                                                ...
                                                <li class="wg-cls hover-img">
                                                    <a href="shop-default.html" class="image img-style">
                                                        <img src="images/products/gym/product-3.jpg"
                                                            data-src="images/products/gym/product-3.jpg" alt="Collection" class="lazyload">
                                                    </a>
                                                    <div class="cls-content">
                                                ...
                                                <ul class="list-ver">
                                                    <li class="prd-recent hover-img">
                                                        <a href="product-detail.html" class="image img-style">
                                                            <img src="images/products/gym/product-7.jpg"
                                                                data-src="images/products/gym/product-7.jpg" alt="Image" class="lazyload">
                                                        </a>
                                                        <div class="content">
                                                    ...
                                                    <li class="prd-recent hover-img">
                                                        <a href="product-detail.html" class="image img-style">
                                                            <img src="images/products/gym/product-9.jpg"
                                                                data-src="images/products/gym/product-9.jpg" alt="Image" class="lazyload">
                                                        </a>
                                                        <div class="content">
                                                            <span class="badge-tag">T-shirt</span>
                                                            <a href="product-detail.html" class="name-prd h6 fw-medium link">
